...
// PgxRepository provides CRUD operations for Postgres
type PgxRepository[Model any] struct {
	db      *sql.DB
	builder *SQLBuilder[Model]
}

// NewPgxRepository initializes a new PgxRepository
func NewPgxRepository[Model any](db *sql.DB) *PgxRepository[Model] {
...
func (r *PgxRepository[Model]) Get(ctx context.Context, where *map[string]any, order *map[string]any, limit *int, skip *int) ([]Model, error) {
	args := []any{}
...
func (r *PgxRepository[Model]) Put(ctx context.Context, models *[]Model) ([]Model, error) {
	result := []Model{}
...
func (r *PgxRepository[Model]) Post(ctx context.Context, models *[]Model) ([]Model, error) {
	args := []any{}
...
func (r *PgxRepository[Model]) Delete(ctx context.Context, where *map[string]any) ([]Model, error) {
	args := []any{}
