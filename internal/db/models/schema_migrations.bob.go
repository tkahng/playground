...
type SchemaMigration struct {
	Version string `db:"version,pk" json:"version"`
}
...
var SchemaMigrationErrors = &schemaMigrationErrors{
	ErrUniqueSchemaMigrationsPkey: &UniqueConstraintError{s: "schema_migrations_pkey"},
}
...
type SchemaMigrationSetter struct {
	Version omit.Val[string] `db:"version,pk" json:"version"`
}
