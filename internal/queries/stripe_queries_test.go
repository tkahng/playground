...
// 		}
// 		if customer.ID != stripeId {
// 			t.Fatalf("expected stripe id %s, got %s", stripeId, customer.ID)
// 		}
// 		type args struct {
// 			ctx      context.Context
// 			dbx      database.Dbx
...
// 					t.Errorf("FindCustomerByStripeId() got = %v, want %v", got.UserID, tt.want.UserID)
// 				}
...
// 				}
// 				if !reflect.DeepEqual(got.UserID, tt.want.UserID) {
// 					t.Errorf("FindCustomerByUserId() got = %v, want %v", got.UserID, tt.want.UserID)
// 				}
// 				if !reflect.DeepEqual(got.ID, tt.want.ID) {
...
// 					return
// 				}
// 				if customer.ID != tt.args.stripeCustomerId {
// 					t.Errorf("Customer stripe ID = %v, want %v", customer.ID, tt.args.stripeCustomerId)
// 				}
// 			})
// 		}
// 		return test.EndTestErr
...
// 		for _, tt := range tests {
// 			t.Run(tt.name, func(t *testing.T) {
// 				err := queries.UpsertSubscriptionFromStripe(tt.args.ctx, tt.args.dbx, tt.args.sub)
// 				if (err != nil) != tt.wantErr {
