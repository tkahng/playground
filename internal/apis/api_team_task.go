...
type Task struct {
	...
	Assignee          *TeamMember       `db:"assignee" src:"assignee_id" dest:"id" table:"team.team_members" json:"assignee,omitempty"`
	Reporter          *TeamMember       `db:"reporter" src:"reporter_id" dest:"id" table:"team.team_members" json:"reporter,omitempty"`
