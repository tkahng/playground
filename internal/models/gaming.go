...
type Player struct {
	...
	RequestingFriendships []*Friendship `db:"requesting_friendships" src:"id" dest:"requesting_player_id" table:"gaming.friendships" json:"requested_friendships,omitempty"`
	InvitedFriendships    []*Friendship `db:"invited_friendships" src:"id" dest:"invited_player_id" table:"gaming.friendships" json:"invited_friendships,omitempty"`
}
...
type Friendship struct {
	...
	Status             FriendshipStatus `db:"status" json:"status" default:"pending" enum:"pending,accepted,declined,blocked"`
