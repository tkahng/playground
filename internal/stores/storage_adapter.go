...
// PlanFeatures implements [StorageAdapterInterface].
func (s *StorageAdapter) PlanFeatures() PlanFeaturesStoreInterface {
	return s.planFeatures
}
...
func (s *StorageAdapter) Ledger() LedgerStore {
	return s.ledger
}
