...
func (s *PostgresStripeStore) FindLatestActiveSubscriptionByTeamId(ctx context.Context, teamId uuid.UUID) (*models.StripeSubscription, error) {
...
func (s *PostgresStripeStore) FindSubscriptionWithPriceById(ctx context.Context, stripeId string) (*models.SubscriptionWithPrice, error) {
...
func (s *PostgresStripeStore) IsFirstSubscription(ctx context.Context, userId uuid.UUID) (bool, error) {
