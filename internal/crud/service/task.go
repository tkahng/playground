...
func (service *TaskService) FindTaskByID(ctx context.Context, db db.Dbx, id uuid.UUID) (*models.Task, error) {
...
// func (service *TaskService) FindLastTaskOrder(ctx context.Context, db db.Dbx, taskProjectID uuid.UUID) (float64, error) {
...
func (service *TaskService) DeleteTask(ctx context.Context, db db.Dbx, taskID uuid.UUID) error {
	_, err := service.task.DeleteReturn(ctx, db, &map[string]any{
		"id": map[string]any{
			"_eq": taskID.String(),
		},
	})
...
func (service *TaskService) FindTaskProjectByID(ctx context.Context, db db.Dbx, id uuid.UUID) (*models.TaskProject, error) {
...
func (service *TaskService) DeleteTaskProject(ctx context.Context, db db.Dbx, taskProjectID uuid.UUID) error {
	_, err := service.taskProject.DeleteReturn(ctx, db, &map[string]any{
		"id": map[string]any{
...
// func (service *TaskService) ListTasks(ctx context.Context, db db.Dbx, input *shared.TaskListParams) ([]*models.Task, error) {
...
//
//	func (service *TaskService) CountTasks(ctx context.Context, db db.Dbx, filter *shared.TaskListFilter) (int64, error) {
//		q := models.Tasks.Query()
//		ListTasksFilterFunc(ctx, q, filter)
...
// func (service *TaskService) ListTaskProjects(ctx context.Context, db db.Dbx, input *shared.TaskProjectsListParams) (models.TaskProjectSlice, error) {
...
// func (service *TaskService) CountTaskProjects(ctx context.Context, db db.Dbx, filter *shared.TaskProjectsListFilter) (int64, error) {
// 	q := models.TaskProjects.Query()
// 	// ListTaskProjectsFilterFunc(ctx, q, filter)
...
// func (service *TaskService) CreateTaskProject(ctx context.Context, db db.Dbx, userID uuid.UUID, input *shared.CreateTaskProjectDTO) (*models.TaskProject, error) {
...
// func (service *TaskService) CreateTaskProjectWithTasks(ctx context.Context, db db.Dbx, userID uuid.UUID, input *shared.CreateTaskProjectWithTasksDTO) (*models.TaskProject, error) {
...
// func (service *TaskService) CreateTaskWithChildren(ctx context.Context, db db.Dbx, userID uuid.UUID, projectID uuid.UUID, input *shared.CreateTaskWithChildrenDTO) (*models.Task, error) {
...
// func (service *TaskService) CreateTask(ctx context.Context, db db.Dbx, userID uuid.UUID, projectID uuid.UUID, input *shared.CreateTaskBaseDTO) (*models.Task, error) {
...
// func (service *TaskService) DefineTaskOrderNumberByStatus(ctx context.Context, db db.Dbx, taskId uuid.UUID, taskProjectId uuid.UUID, status models.TaskStatus, currentOrder float64, position int64) (float64, error) {
// 	if position == 0 {
...
// func (service *TaskService) DefineTaskOrderNumber(ctx context.Context, db db.Dbx, taskId uuid.UUID, taskProjectId uuid.UUID, currentOrder float64, position int64) (float64, error) {
// 	if position == 0 {
// 		response, err := models.Tasks.Query(
// 			sm.Where(models.TaskColumns.ProjectID.EQ(psql.Arg(taskProjectId))),
// 			sm.OrderBy(models.TaskColumns.Order).Asc(),
...
// func (service *TaskService) UpdateTask(ctx context.Context, db db.Dbx, taskID uuid.UUID, input *shared.UpdateTaskBaseDTO) error {
...
// func (service *TaskService) UpdateTaskProjectUpdateDate(ctx context.Context, db db.Dbx, taskProjectID uuid.UUID) error {
...
// func (service *TaskService) UpdateTaskProject(ctx context.Context, db db.Dbx, taskProjectID uuid.UUID, input *shared.UpdateTaskProjectBaseDTO) error {
...
// func (service *TaskService) UpdateTaskPosition(ctx context.Context, db db.Dbx, taskID uuid.UUID, position int64) error {
// 	task, err := FindTaskByID(ctx, db, taskID)
// 	if err != nil {
// 		return err
// 	}
...
// func (service *TaskService) UpdateTaskPositionStatus(ctx context.Context, db db.Dbx, taskID uuid.UUID, position int64, status models.TaskStatus) error {
// 	task, err := FindTaskByID(ctx, db, taskID)
// 	if err != nil {
// 		return err
// 	}
